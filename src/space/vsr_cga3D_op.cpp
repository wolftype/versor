...
Grt Gen::rot(const Dll &d) { return nga::Gen::rot(d); }

Grt Gen::rotor(const Dll &d) { return nga::Gen::rot(d); }

Dll Gen::log(const Grt &g) { return nga::Gen::log(g); }
...
/*! Dual Line Generator from a Motor
        An implementation of J.Lasenby et al "Applications of Conformal
