...
namespace vsr { namespace cga {
   ...
   */
    ...
    */
     ...
     DirectionTrivector Round::direction( const Sphere& c ) { return vsr::nga::Round::direction(c); }
...
//     )
    ...
    */
    ...
    /// Theta in radians of point p relative to circle circle. @todo, does not consider quadrant!
    VSR_PRECISION Round::theta( const Circle& circle, const Point& point){
      ...
      auto tx = Vec::x.spin( vsr::nga::Gen::ratio( Vec::z, Vec(Round::carrier(circle).dual().unit())) );
