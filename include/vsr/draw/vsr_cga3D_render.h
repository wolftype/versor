 ...
 *    template specializations of gfx_renderable
 *
 *        Version:  1.0
...
/*-----------------------------------------------------------------------------
 *  FIELDS (arrays) CAN VARY IN SIZE, SO USER IS RESPONSIBLE TO Add BUFFER ONLY
 *ONCE (the GetMeshBuffer uses address of argument to check for existence the
 *mMBOmap)
 *-----------------------------------------------------------------------------*/
...
template <>
void Renderable<cga::Frame>::Draw(const cga::Frame &, GFXSceneNode *s);
template <> void Renderable<cga::Cir>::Draw(const cga::Cir &, GFXSceneNode *s);
template <>
void Renderable<vector<cga::Cir>>::Draw(const vector<cga::Cir> &,
                                        GFXSceneNode *s);
...
template <> void Renderable<cga::Vec>::Draw(const cga::Vec &, GFXSceneNode *s);

template <>
void Renderable<Field<cga::Vec>>::Draw(const Field<cga::Vec> &,
                                       GFXSceneNode *s);
template <>
void Renderable<Field<cga::Pnt>>::Draw(const Field<cga::Pnt> &,
                                       GFXSceneNode *s);

extern template void Renderable<cga::Frame>::Draw(const cga::Frame &,
                                                  GFXSceneNode *s);
extern template void Renderable<cga::Cir>::Draw(const cga::Cir &,
                                                GFXSceneNode *s);
extern template void
Renderable<vector<cga::Cir>>::Draw(const vector<cga::Cir> &, GFXSceneNode *s);

extern template void Renderable<cga::Pnt>::Draw(const cga::Pnt &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Sph>::Draw(const cga::Sph &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Par>::Draw(const cga::Par &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Dll>::Draw(const cga::Dll &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Lin>::Draw(const cga::Lin &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Dlp>::Draw(const cga::Dlp &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Pln>::Draw(const cga::Pln &,
                                                GFXSceneNode *s);
extern template void Renderable<cga::Biv>::Draw(const cga::Biv &,
                                                GFXSceneNode *s);
extern template void Renderable<Field<cga::Vec>>::Draw(const Field<cga::Vec> &,
                                                       GFXSceneNode *s);
extern template void Renderable<Field<cga::Pnt>>::Draw(const Field<cga::Pnt> &,
                                                       GFXSceneNode *s);
...
/*         (real) ? gfx::Glyph::SolidSphere(t, 5+ floor(t*30), 5+floor(t*30)) :
 * Glyph::Sphere(t); */
/*     } else { */
/*         gfx::Glyph::Point(s); */
/*     } */
