...
//   using namespace types;
  ...
  class Frame{
    ...
    /// Construct from Vector of Coordinates, Rotor, and Scale
    Frame(const Vec& v, const Rotor& r = Rot(1,0,0,0), VSR_PRECISION s = 1);
    /// Construct from Point Coordiantes, Rotor, and Scale
    ...
    Frame(const Motor& m );
    /// Construct from Tangent vector (null point pair)

    /// Construct form Tangent Bivector (null circle)
